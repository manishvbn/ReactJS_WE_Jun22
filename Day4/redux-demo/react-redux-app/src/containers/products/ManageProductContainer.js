...
function mapDispatchToProps(dispatch) {
    return {
        insertProduct: (product, onSuccess) => { dispatch(productActions.insertProduct(product, onSuccess)); },
        updateProduct: (product, onSuccess) => { dispatch(productActions.updateProduct(product, onSuccess)); }
    };
}
